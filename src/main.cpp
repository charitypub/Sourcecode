...
uint256 hashGenesisBlock("0x7e20c85d1238c546680bbd84f68d6b0bba1d3c66df3aee7899fc8732df0556e5");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Charity: starting difficulty is 1 / 2^12
...
{
    // Charity: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Charity: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Charity: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1523389530, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04622e67d62cabf6a65a97b99597c5f39f4bbb8e1ee09f64355dc58a72712cff208319b2cf8244c18bfaa63162ffc5847a34d6c6a70f04e4e6ceb4d9ff368053b7") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1523389530;
        ...
        assert(block.hashMerkleRoot == uint256("0xe464ae6c3b70faf582aebf81c63ce95fb7b1a7aa91b351ed83ba5b0b909601b4"));
...
unsigned char pchMessageStart[4] = { 0x70, 0x38, 0x8e, 0x3c }; // Charity: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CharityMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CharityMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static CharityMiner(CWallet *pwallet)
{
    printf("CharityMiner started\n");
    ...
    try { loop {
        ...
        printf("Running CharityMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CharityMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&CharityMiner, pwallet));
}
