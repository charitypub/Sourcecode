...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 36303 or testnet: 46303)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 36304 or testnet: 46304)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Charity Wiki for SSL setup instructions)") + "\n" +
